...
const Footer = ()=>{
    return(
            <footer className="flex flex-col-reverse items-center bg-[#171618] justify-between px-[5rem] py-10 mx-auto space-y-8 md:flex-row md:space-y-0">
                ...
                <div>
                    <img className="mx-auto h-[75px] w-auto"
                ...
                <div>
                    <div className='pb-[5px] text-[18px] text-white'>We don’t keep our beauty secrets</div>
                    <div className='pb-[5px] text-[14px] text-white'>Subscribe now and thank us later</div>
                    <form 
                    id="contact" 
                    onSubmit={(e) => {
                        e.preventDefault();
