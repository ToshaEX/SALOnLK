          ...
          <div className="flex justify-end align-center gap-5">
            <div className="pt-[1rem] flex justify-center h-[3.5rem] gap-3">
              <button
                ...
                className="px-10 bg-primary rounded-md border border-transparent bg-primary px-4 text-sm font-medium text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
              >
                Yes
              </button>
              <button
